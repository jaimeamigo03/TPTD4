...
porcentajes_ttl_zero = [ttl_zero_utdt, ttl_zero_hvd, ttl_zero_unisa, ttl_zero_pku, ttl_zero_cam]

# Crear un gráfico de barras
fig, ax = plt.subplots()
bars = ax.bar(destinos, porcentajes_ttl_zero, color="cornflowerblue")
ax.set_xlabel('Destino', labelpad=15, color='black')
ax.set_ylabel('Tiempo', labelpad=15, color='black')
ax.set_title('Tiempo promedio de RTT por destino', pad=15, color='black', weight='bold')
ax.set_ylim(0, 250)
ax.grid(False)
